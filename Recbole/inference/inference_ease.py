...
def main():
    ...
    parser.add_argument("--model_file", default="/data/ephemeral/home/saved/EASE-May-01-2024_03-51-27.pth", type=str)
    ...
    pd.DataFrame(result, columns=["user_id", "item_id"]).to_csv(
        os.path.join(args.output_dir,"output_ease.csv"), index=False
    )
